...
public class ShoppingCart {
     ...
     * incremented.
     *
     * @param product the <code>Ksiazki</code> that defines the type of shopping cart item
     * @see ShoppingCartItem
     */
    public synchronized int addItem(Ksiazki product) {

        boolean newItem = true;

        for (ShoppingCartItem scItem : items) {

            if (scItem.getProduct().getIsbn()== product.getIsbn()) {
     ...
     * @see ShoppingCartItem
     */
    public synchronized int update(Ksiazki product, String quantity) {
